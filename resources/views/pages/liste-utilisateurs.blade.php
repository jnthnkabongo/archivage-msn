        ...
        <aside class="w-64 bg-white shadow-lg min-h-screen fixed left-0 top-16 z-40 border-r border-gray-200">
            <div class="p-6">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="" class="flex items-center p-3 text-gray-700 rounded-lg bg-gray-100 group">
                            <i class="fas fa-users text-gray-500 mr-3 group-hover:text-gray-700 transition-colors"></i>
                            <span class="font-medium">Utilisateurs</span>
                            <span class="ml-auto bg-gray-800 text-white text-xs px-2 py-1 rounded-full">42</span>
                        </a>
                    </li>
                    <li>
