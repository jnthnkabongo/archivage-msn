                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="servicesTableBody" class="bg-white divide-y divide-gray-200">
                            ...
                            {{-- <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">rh@mns.cd</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Actif</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div class="p-2 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">12</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">marketing@mns.cd</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Actif</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" class="rounded border-gray-300" value="4">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">Archivage</div>
                                            <div class="text-xs text-gray-500">ID: #004</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Sophie Durand</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">6</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">archive@mns.cd</td>
                                <td class="px-6 py-4 whitespace-nowrap">
